    ...
    <div className="relative mt-4 w-full sm:w-80 max-w-sm p-4 box-border">
      <div className="border rounded-lg bg-white shadow-md overflow-hidden">
        ...
        <div className="flex items-center p-4">
          <div>
            <span className="font-semibold font-lexend text-lg">
              {post.userName}
            </span><br/>
      ...
      <div className="absolute -bottom-1 left-0 right-0 flex justify-between px-4">
        ...
        {/* Right-side div */}
        <div className="absolute mt-[10px] w-[220px] sm:w-[130px] md:w-[140px] lg:w-[150px] h-8 ml-[120px] sm:ml-[120px] md:ml-[130px] lg:ml-[138px] flex items-center justify-between p-4 rounded-tl-[150px] border-l bg-secondary border-t-transparent border-b-transparent"></div>
      </div>
    </div>
  );
};
...
//       <div className="absolute -bottom-1 left-0 right-0 flex justify-between px-4">
//         {/* Left-side actions */}
//         <div className="-bottom-8 flex items-center space-x-4 bg-white p-4 rounded-md">
//           <div className="relative">
//             {liked && isAnimating && (
//               <div className="absolute inset-0 flex items-center justify-center">
//                 <FaHeart className="text-red-600 text-3xl animate-ping" />
