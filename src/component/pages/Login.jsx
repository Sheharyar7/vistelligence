  ...
  return (
    <>
     <nav className="text-white px-4 bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 py-3 flex items-center">
      ...
      <div className="flex items-center justify-center min-h-screen relative p-5 bg-gray-200">
        {/* Blurred Background */}
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: "url('/images/Post2.jpg')", // Path to your background image
        ...
        {/* Form Container */}
        <div className="relative z-10 w-full max-w-md p-8 bg-gray-800 bg-opacity-90 text-white rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-center mb-6 font-lexend">Login</h2>
